const products = [
    { id: 1, cat: 'hardware', name: 'Samsung Odyssey G9', price: 980, descriptive: 'شاشة عملاقة منحنية مقاس 49 بوصة تمنحك تجربة غامرة لا مثيل لها.', img: 'https://tse4.mm.bing.net/th/id/OIP.b-tbvaypCSPcnSOWKOoDxQHaE8?rs=1&pid=ImgDetMain&o=7&rm=3' },
    { id: 2, cat: 'hardware', name: 'LG OLED C3', price: 1200, descriptive: 'شاشة بدقة 4K وألوان مذهلة، الخيار الأفضل لأجهزة PS5 و Xbox.', img: 'https://tse2.mm.bing.net/th/id/OIP.0c-S987sWOZb8n1tgCxxIgAAAA?w=300&h=186&rs=1&pid=ImgDetMain&o=7&rm=3' }
];
let cart = [];
let lastOrderID = "";
